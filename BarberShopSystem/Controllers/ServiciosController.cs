...
namespace BarberShopSystem.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,Duracion,Precio")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,Duracion,Precio")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
